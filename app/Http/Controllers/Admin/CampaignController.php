...
class CampaignController extends Controller
{
    ...
    public function listing(Request $request)
    {
        ...
        return view('admin.campaigns._list', [
            'campaigns' => $campaigns,
        ]);
    }
    ...
    public function create(Request $request)
    {
        ...
        return redirect()->action('Admin\CampaignController@recipients', ['uid' => $campaign->uid]);
    }
    ...
    public function show($id)
    {
        ...
        if ($campaign->status == 'new') {
            return redirect()->action('Admin\CampaignController@edit', ['uid' => $campaign->uid]);
        } else {
            return redirect()->action('Admin\CampaignController@overview', ['uid' => $campaign->uid]);
        }
    }
    ...
    public function edit($id)
    {
        ...
        if ($campaign->step() == 0) {
            ...
            return redirect()->action('Admin\CampaignController@setup', ['uid' => $campaign->uid]);
        } elseif ($campaign->step() == 2) {
            return redirect()->action('Admin\CampaignController@template', ['uid' => $campaign->uid]);
        } elseif ($campaign->step() == 3) {
            return redirect()->action('Admin\CampaignController@schedule', ['uid' => $campaign->uid]);
        } elseif ($campaign->step() >= 4) {
            return redirect()->action('Admin\CampaignController@confirm', ['uid' => $campaign->uid]);
        }
    }
    ...
    public function recipients(Request $request)
    {
        ...
        return view('admin.campaigns.recipients', [
            'campaign' => $campaign,
            'rules' => $rules,
        ]);
    }
    ...
    public function setup(Request $request)
    {
        ...
        return view('admin.campaigns.setup', [
            'campaign' => $campaign,
            'rules' => $campaign->rules(),
        ]);
    }
    ...
    public function template(Request $request)
    {
        ...
        if ($campaign->type == 'plain-text') {
            return redirect()->action('Admin\CampaignController@plain', ['uid' => $campaign->uid]);
        }

        // check if campagin does not have template
        if (!$campaign->template) {
            return redirect()->action('Admin\CampaignController@templateCreate', ['uid' => $campaign->uid]);
        }

        return view('admin.campaigns.template.index', [
            'campaign' => $campaign,
    ...
    public function templateLayout(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            // return redirect()->action('Admin\CampaignController@templateEdit', $campaign->uid);
            return response()->json([
                'status' => 'success',
                'message' => trans('messages.campaign.theme.selected'),
                'url' => action('Admin\CampaignController@templateBuilderSelect', $campaign->uid),
            ]);
        }
        ...
        return view('admin.campaigns.template.layout', [
            'campaign' => $campaign
        ]);
    }
    ...
    public function templateLayoutList(Request $request)
    {
        ...
        return view('admin.campaigns.template.layoutList', [
            'campaign' => $campaign,
            'templates' => $templates,
        ]);
    }
    ...
    public function templateBuilderSelect(Request $request, $uid)
    {
        ...
        return view('admin.campaigns.template.templateBuilderSelect', [
            'campaign' => $campaign,
        ]);
    }
    ...
    public function templateEdit(Request $request)
    {
        ...
        return view('admin.campaigns.template.edit', [
            'campaign' => $campaign,
    ...
    public function templateContent(Request $request)
    {
        ...
        return view('admin.campaigns.template.content', [
    ...
    public function templateUpload(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            // return redirect()->action('Admin\CampaignController@template', $campaign->uid);
            return response()->json([
                'status' => 'success',
        ...
        return view('admin.campaigns.template.upload', [
            'campaign' => $campaign,
        ]);
    }
    ...
    public function plain(Request $request)
    {
        ...
        return view('admin.campaigns.plain', [
            'campaign' => $campaign,
        ]);
    }
    ...
    public function schedule(Request $request)
    {
        ...
        return view('admin.campaigns.schedule', [
            'campaign' => $campaign,
            'rules' => $rules,
        ...
        if ($request->isMethod('post') && $campaign->step() >= 5) {
            ...
            if ($plan->getOption('unsubscribe_url_required') == 'yes' && Setting::isYes('campaign.enforce_unsubscribe_url_check')) {
                if (strpos($campaign->getTemplateContent(), '{UNSUBSCRIBE_URL}') === false) {
                    ...
                    return view('admin.campaigns.confirm', [
                        'campaign' => $campaign,
                        'score' => $score,
                    ]);
                }
    ...
    public function delete(Request $request)
    {
        ...
        echo trans('messages.admin.campaigns.deleted');
    }
    ...
    public function overview(Request $request)
    {
        ...
        return view('admin.campaigns.overview', [
            'campaign' => $campaign,
        ]);
    }
    ...
    public function links(Request $request)
    {
        ...
        return view('admin.campaigns.links', [
            'campaign' => $campaign,
            'links' => $links,
        ]);
    }
    ...
    public function quickView(Request $request)
    {
        ...
        return view('admin.campaigns._quick_view', [
            'campaign' => $campaign,
        ]);
    }
    ...
    public function trackingLog(Request $request)
    {
        ...
        return view('admin.campaigns.tracking_log', [
            'items' => $items,
            'campaign' => $campaign,
        ]);
    }
    ...
    public function trackingLogDownload(Request $request)
    {
        ...
        return view('admin.campaigns.download_tracking_log', [
            'campaign' => $campaign,
            'job' => $monitor,
        ]);
    }
    ...
    public function trackingLogExportProgress(Request $request)
    {
        ...
        $progress['download'] = action('Admin\CampaignController@download', ['uid' => $job->uid]);
    ...
    public function bounceLog(Request $request)
    {
        ...
        return view('admin.campaigns.bounce_log', [
            'items' => $items,
            'campaign' => $campaign,
        ]);
    }
    ...
    public function feedbackLog(Request $request)
    {
        ...
        return view('admin.campaigns.feedback_log', [
            'items' => $items,
            'campaign' => $campaign,
        ]);
    }
    ...
    public function openLog(Request $request)
    {
        ...
        return view('admin.campaigns.open_log', [
            'items' => $items,
            'campaign' => $campaign,
        ]);
    }
    ...
    public function clickLog(Request $request)
    {
        ...
        return view('admin.campaigns.click_log', [
            'items' => $items,
            'campaign' => $campaign,
        ]);
    }
    ...
    public function unsubscribeLog(Request $request)
    {
        ...
        return view('admin.campaigns.unsubscribe_log', [
            'items' => $items,
            'campaign' => $campaign,
        ]);
    }
    ...
    public function openMap(Request $request)
    {
        ...
        return view('admin.campaigns.open_map', [
            'campaign' => $campaign,
        ]);
    }
    ...
    public function deleteConfirm(Request $request)
    {
        ...
        return view('admin.campaigns.delete_confirm', [
            'lists' => $lists,
        ]);
    }
    ...
    public function pause(Request $request)
    {
        ...
        return response()->json([
            'status' => 'success',
            'message' => trans('messages.admin.campaigns.paused'),
        ]);
    }
    ...
    public function restart(Request $request)
    {
        ...
        // Redirect to my lists page
        echo trans('messages.admin.campaigns.restarted');
    }
    ...
    public function subscribers(Request $request)
    {
        ...
        return view('admin.campaigns.subscribers', [
    ...
    public function subscribersListing(Request $request)
    {
        ...
        return view('admin.campaigns._subscribers_list', [
            'subscribers' => $subscribers,
            'list' => $campaign->defaultMailList,
            'campaign' => $campaign,
            'fields' => $fields,
    ...
    public function templateBuild(Request $request)
    {
        ...
        return view('admin.campaigns.template_build', [
            'campaign' => $campaign,
            'elements' => $elements,
            'list' => $campaign->defaultMailList,
        ]);
    ...
    public function templateRebuild(Request $request)
    {
        ...
        return view('admin.campaigns.template_rebuild', [
            'campaign' => $campaign,
            'list' => $campaign->defaultMailList,
        ]);
    }
    ...
    public function copy(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            // redirect if fails
            if ($validator->fails()) {
                return response()->view('admin.campaigns.copy', [
                    'campaign' => $campaign,
        ...
        return view('admin.campaigns.copy', [
            'campaign' => $campaign,
        ]);
    }
    ...
    public function sendTestEmail(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            //
            if ($validator->fails()) {
                return response()->view('admin.campaigns.sendTestEmail', [
                    'campaign' => $campaign,
                    'errors' => $validator->errors(),
                ], 400);
            }
        ...
        return view('admin.campaigns.sendTestEmail', [
            'campaign' => $campaign,
        ]);
    }
    ...
    public function listSegmentForm(Request $request)
    {
        ...
        return view('admin.campaigns._list_segment_form', [
            'campaign' => $campaign,
            'lists_segment_group' => [
                'list' => null,
                'is_default' => false,
    ...
    public function webView(Request $request)
    {
        ...
        try {
            ...
            return view('admin.campaigns.web_view', [
                'campaign' => $campaign,
                'subscriber' => $subscriber,
                'message_id' => $message_id,
            ]);
    ...
    public function selectType(Request $request)
    {
        ...
        return view('admin.campaigns.select_type');
    }
    ...
    public function templateReview(Request $request)
    {
        ...
        return view('admin.campaigns.template_review', [
            'campaign' => $campaign,
        ]);
    }
    ...
    public function templateReviewIframe(Request $request)
    {
        ...
        return view('admin.campaigns.template_review_iframe', [
            'campaign' => $campaign,
        ]);
    }
    ...
    public function resend(Request $request, $uid)
    {
        ...
        return view('admin.campaigns.resend', [
            'campaign' => $campaign,
        ]);
    }
    ...
    public function spamScore(Request $request, $uid)
    {
        ...
        return view('admin.campaigns.spam_score', [
            'score' => $score,
        ]);
    }
    ...
    public function builderClassic(Request $request, $uid)
    {
        ...
        return view('admin.campaigns.builderClassic', [
            'campaign' => $campaign,
        ]);
    }
    ...
    public function builderPlainEdit(Request $request, $uid)
    {
        ...
        return view('admin.campaigns.builderPlainEdit', [
            'campaign' => $campaign,
        ]);
    }
    ...
    public function customPlainOn(Request $request)
    {
        ...
        return redirect()->action('Admin\CampaignController@builderPlainEdit', [
            'uid' => $campaign->uid,
        ]);
    }
    ...
    public function previewAs(Request $request)
    {
        ...
        return view('admin.campaigns.previewAs', [
            'campaign' => $campaign,
        ]);
    }
    ...
    public function previewAsList(Request $request)
    {
        ...
        return view('admin.campaigns.previewAsList', [
            'subscribers' => $subscribers,
            'campaign' => $campaign,
        ]);
    }
