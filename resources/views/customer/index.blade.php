                                                ...
                                                <div class="card card-bordered card-full">
                                                    <div class="nk-wg1">
                                                        ...
                                                        <div class="nk-wg1-action">
                                                            <a href="{{ url('customer/quotes') }}" class="link"><span>My Quotes</span> <em class="icon ni ni-chevron-right"></em></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div><!-- .col -->
                                        ...
                                        <div class="card card-bordered">
                                            <div class="card-inner card-inner-md">
                                                <div class="card-title-group">
                                                    <h6 class="card-title">Quotes History</h6>
                                                    <div class="card-action">
                                                        <a href="customer/subscription/payments.html" class="link link-sm">See All <em class="icon ni ni-chevron-right"></em></a>
                                                    </div>
                                                </div>
                                            </div>
