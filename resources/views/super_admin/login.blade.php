                ...
                <div class="nk-content ">
                    <div class="nk-block nk-block-middle nk-auth-body  wide-xs">
                        <div class="brand-logo pb-4 text-center">
                            <a href="{{url('super-admin/login')}}" class="logo-link">
                        ...
                        <div class="card">
                            <div class="card-inner card-inner-lg">
                                <div class="nk-block-head">
                                    <div class="nk-block-head-content">
                                        ...
                                        <div class="nk-block-des">
                                            <p>Access the Quotebiz super-admin panel using your email and password.</p>
                                        </div>
                                    </div>
                                </div>
                                <form action="{{url('super-admin')}}">
                                ...
                                <div class="form-note-s2 text-center pt-4"> New on our platform? <a href="{{ url('super-admin/register')}}">Create an account</a>
                                </div>
