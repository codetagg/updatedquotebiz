                                            ...
                                            <table class="table table-tickets">
                                                ...
                                                <tbody class="tb-ticket-body">
                                                    <tr class="tb-ticket-item is-unread">
                                                        <td class="tb-ticket-id"><a href="{{url('admin/supportchat') }}">C506223</a></td>
                                                        ...
                                                        <td class="tb-ticket-action">
                                                            <a href="{{url('admin/supportchat') }}" class="btn btn-icon btn-trigger">
                                                                <em class="icon ni ni-chevron-right"></em>
                                                            </a>
                                                        </td>
                                                    </tr><!-- .tb-ticket-item -->
                                                    <tr class="tb-ticket-item">
                                                        <td class="tb-ticket-id"><a href="{{url('admin/supportchat') }}">C503095</a></td>
                                                        <td class="tb-ticket-desc">
                                                            <a href="{{url('admin/supportchat') }}"><span class="title">Payment was rejected</span></a>
                                                        </td>
                                                        <td class="tb-ticket-date tb-col-md">
                                                    ...
                                                    <tr class="tb-ticket-item">
                                                        <td class="tb-ticket-id"><a href="{{url('admin/supportchat') }}">C502049</a></td>
                                                        <td class="tb-ticket-desc">
                                                            <a href="{{url('admin/supportchat') }}"><span class="title">We cannot install on our server</span></a>
                                                        </td>
                                                        <td class="tb-ticket-date tb-col-md">
                                                    ...
                                                    <tr class="tb-ticket-item">
                                                        <td class="tb-ticket-id"><a href="{{url('admin/supportchat') }}">C502035</a></td>
                                                        <td class="tb-ticket-desc">
                                                            <a href="{{url('admin/supportchat') }}"><span class="title">Support for website</span></a>
                                                        </td>
                                                        <td class="tb-ticket-date tb-col-md">
                                                    ...
                                                    <tr class="tb-ticket-item is-unread">
                                                        <td class="tb-ticket-id"><a href="{{url('admin/supportchat') }}">C501783</a></td>
                                                        <td class="tb-ticket-desc">
                                                            <a href="{{url('admin/supportchat') }}"><span class="title">We cannot install on our server</span></a>
                                                        </td>
                                                        <td class="tb-ticket-date tb-col-md">
                                                    ...
                                                    <tr class="tb-ticket-item">
                                                        <td class="tb-ticket-id"><a href="{{url('admin/supportchat') }}">C501624</a></td>
                                                        <td class="tb-ticket-desc">
                                                            <a href="{{url('admin/supportchat') }}"><span class="title">Setup Local Payment Gateway</span></a>
                                                        </td>
                                                        <td class="tb-ticket-date tb-col-md">
                                                    ...
                                                    <tr class="tb-ticket-item">
                                                        <td class="tb-ticket-id"><a href="{{url('admin/supportchat') }}">C501605</a></td>
                                                        <td class="tb-ticket-desc">
                                                            <a href="{{url('admin/supportchat') }}"><span class="title">Unable to set automated email response</span></a>
                                                        </td>
                                                        <td class="tb-ticket-date tb-col-md">
                                                    ...
                                                    <tr class="tb-ticket-item">
                                                        <td class="tb-ticket-id"><a href="{{url('admin/supportchat') }}">C501579</a></td>
                                                        <td class="tb-ticket-desc">
                                                            <a href="{{url('admin/supportchat') }}"><span class="title">Setup Local Payment Gateway</span></a>
                                                        </td>
                                                        <td class="tb-ticket-date tb-col-md">
